      ...
      <div className="md:hidden">
        ...
        {mobileMenuOpen && (
          <>
            ...
            {/* Menu Content */}
            <div className="fixed top-[56px] left-0 right-0 bottom-0 bg-white dark:bg-neutral-900 z-[101] overflow-y-auto transition-all duration-300 ease-in-out shadow-2xl">
