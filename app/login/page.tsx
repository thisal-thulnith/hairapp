      ...
      <div className="w-full max-w-md bg-white dark:bg-neutral-900 rounded-2xl shadow-lg dark:shadow-xl p-8 transition-colors">
        ...
        <div className="space-y-3 mb-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-neutral-200 dark:border-neutral-700 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors cursor-pointer"
          >
