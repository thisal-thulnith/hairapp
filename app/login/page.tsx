...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#fdfcfb] to-[#f7f5f3] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-semibold text-[#2a2a2a] mb-2">Welcome Back</h1>
          <p className="text-sm text-[#666]">Login to continue your journey</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex justify-end">
            <Link href="/forgot-password" className="text-sm text-[#8B7355] hover:text-[#6d5a42] transition-colors">
              Forgot Password?
            </Link>
          </div>
          ...
          <button
            type="submit"
            className="w-full py-3 bg-[#5a4a3a] text-white text-sm font-medium rounded-lg hover:bg-[#4a3a2a] transition-colors"
          >
            Login
          </button>
        </form>
        ...
        <div className="mt-6 text-center text-sm">
          ...
          <Link href="/signup" className="text-[#8B7355] hover:text-[#6d5a42] font-medium transition-colors">
            Sign Up
          </Link>
        </div>
      </div>
