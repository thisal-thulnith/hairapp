      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="space-y-3 mb-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-neutral-200 rounded-lg hover:bg-neutral-50 transition-colors cursor-pointer"
          >
